...
namespace parser_selenium.TG_BOT
{
    internal class Bot
    {
        ...
        public static async Task Run()
        {
            ...
            _botClient = new TelegramBotClient(Imports.Data.importToken()); // Присваиваем нашей переменной значение, в параметре передаем Token, полученный от BotFather
                    ...
                    case UpdateType.Message:
                        {
                            ...
                            switch (update.Message.Text.ToLower())
                            {
                                ...
                                case "/start":
                                    {
                                        await botClient.SendMessage(chat.Id,"you picked /start");
